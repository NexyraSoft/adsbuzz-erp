...
import { Invoice, PlatformType } from '../../types';
...
function ReportsView({ invoices, onTriggerExport }: ReportsViewProps) {
      ...
      <div className="bg-white dark:bg-slate-900 p-5 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm space-y-5 max-w-6xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div>
            ...
            <select
              value={platform}
              onChange={(e) => setPlatform(e.target.value as 'All' | PlatformType)}
