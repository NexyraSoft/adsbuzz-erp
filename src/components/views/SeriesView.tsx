...
import { Series, AdAccount, PlatformType } from '../../types';
...
function SeriesView({ series, adAccounts, onAddSeries, onUpdateSeries }: SeriesViewProps) {
      ...
      >
        <form onSubmit={handleSubmit} className="space-y-4" id="form-add-series">
          ...
          <div>
            ...
            <select value={newStatus} onChange={(e) => setNewStatus(e.target.value as Series['status'])} className="w-full text-xs p-2 bg-slate-50 dark:bg-slate-950 rounded-lg border border-slate-200 dark:border-slate-800 dark:text-white font-medium">
        ...
        <form onSubmit={handleEditSubmit} className="space-y-4" id="form-edit-series">
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) => editSeriesData && setEditSeriesData({ ...editSeriesData, platform: e.target.value as PlatformType })}
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) => editSeriesData && setEditSeriesData({ ...editSeriesData, status: e.target.value as Series['status'] })}
              className="w-full text-xs p-2 bg-slate-50 dark:bg-slate-950 rounded-lg border border-slate-200 dark:border-slate-800 dark:text-white font-medium"
            >
              <option value="Active">Active</option>
