...
interface AdAccountsViewProps {
  ...
  /** When true, the "Add Account" modal is opened automatically on mount. */
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <select
              ...
              onChange={(e) => setPlatformFilter(e.target.value as 'All' | PlatformType)}
            >
            ...
            <select
              ...
              className="text-xs bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg px-2.5 py-1.5 focus:outline-none"
              value={statusFilter}
              onChange={(e) => setStatusFilter(e.target.value as 'All' | AdAccount['accountStatus'])}
            >
            ...
            <select
              ...
              onChange={(e) => setAssignmentFilter(e.target.value as 'All' | 'Assigned' | 'Available')}
            >
                    ...
                    <td className="py-3.5 text-center">
                      <div className="flex items-center justify-center gap-1.5">
                        ...
                        <select
                          ...
                          onChange={(e) => onUpdateAccountStatus(acc.adAccountId, e.target.value as AdAccount['accountStatus'])}
                        >
                          <option value="Sold">Sold</option>
                          <option value="Disable">Disable</option>
                          <option value="Need Support">Need Support</option>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) => setNewAccountStatus(e.target.value as AdAccount['accountStatus'])}
              >
                <option value="Sold">Sold</option>
                <option value="Disable">Disable</option>
                <option value="Need Support">Need Support</option>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div>
              ...
              <select
                ...
                onChange={(e) => editAccountData && setEditAccountData({ ...editAccountData, platform: e.target.value as PlatformType })}
              >
                <option value="Facebook">Facebook</option>
                <option value="TikTok">TikTok</option>
                <option value="Google">Google</option>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) => editAccountData && setEditAccountData({ ...editAccountData, accountStatus: e.target.value as AdAccount['accountStatus'] })}
              >
                <option value="Sold">Sold</option>
                <option value="Disable">Disable</option>
                <option value="Need Support">Need Support</option>
