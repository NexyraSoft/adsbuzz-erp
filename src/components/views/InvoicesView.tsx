...
function InvoicesView({ invoices, customers, onUpdateInvoice }: InvoicesViewProps) {
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <select
                ...
                onChange={(e) => editingInvoice && setEditingInvoice({ ...editingInvoice, paymentStatus: e.target.value as Invoice['paymentStatus'] })}
                className="w-full text-xs p-2 bg-slate-50 dark:bg-slate-950 rounded-lg border border-slate-200 dark:border-slate-800 dark:text-white font-medium"
              >
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) => editingInvoice && setEditingInvoice({ ...editingInvoice, approvalStatus: e.target.value as Invoice['approvalStatus'] })}
                className="w-full text-xs p-2 bg-slate-50 dark:bg-slate-950 rounded-lg border border-slate-200 dark:border-slate-800 dark:text-white font-medium"
              >
