...
import { SaleSetup, Customer, AdAccount } from '../../types';
...
function SaleSetupView({ setups, customers, adAccounts, onAddSetup, onUpdateSetup }: SaleSetupViewProps) {
        ...
        <div>
          ...
          {isEdit ? (
            <select
              ...
              onChange={(e) => setData!({ ...data!, serviceType: e.target.value as SaleSetup['serviceType'] })}
            ...
            <select
              ...
              onChange={(e) => setFormServiceType(e.target.value as SaleSetup['serviceType'])}
              className="w-full text-xs p-2 bg-slate-50 dark:bg-slate-950 rounded-lg border border-slate-200 dark:border-slate-800 dark:text-white font-medium"
            >
              <option value="Ad Account Topup">Ad Account Top-up</option>
              <option value="Others">Others</option>
          ...
          <div>
            ...
            {isEdit ? (
              <select
                ...
                onChange={(e) => setData!({ ...data!, status: e.target.value as SaleSetup['status'] })}
                className="w-full text-xs p-2 bg-slate-50 dark:bg-slate-950 rounded-lg border border-slate-200 dark:border-slate-800 dark:text-white font-medium"
              >
              ...
              <select
                value={formStatus}
                onChange={(e) => setFormStatus(e.target.value as SaleSetup['status'])}
                className="w-full text-xs p-2 bg-slate-50 dark:bg-slate-950 rounded-lg border border-slate-200 dark:border-slate-800 dark:text-white font-medium"
              >
                <option value="Active">Active</option>
                <option value="Sold">Sold</option>
